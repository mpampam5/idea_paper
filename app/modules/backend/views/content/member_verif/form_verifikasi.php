<?php if ($row->is_complate=="1"): ?>
  ...
  <?php else: ?>
    <div class="row">
      <div class="col-sm-12">
        <p style="font-size:14px;font-weight:600;font-style:italic;color:#3b3b3b" class="text-center mt-5">Data member belum lengkap, silahkan hubungi member untuk melengkapi data.</p>
      </div>
    </div>
<?php endif; ?>
