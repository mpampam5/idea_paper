      ...
      <div class="card-body">
          ...
          <div class="row">
              ...
              <div class="col-md-2 bg-white profile-menu-bar border-right">
                <div class="menu-bar">
                  <ul class="menu-items">
                    <li ><a href="<?=site_url("backend/member/detail/personal/".enc_uri($id_person)."/$id_register")?>" <?=$this->uri->segment(4)=="personal" ? 'class="active"':''?>><i class="ti-id-badge"></i> Data Personal</a></li>
                    ...
                    <li><a href="<?=site_url("backend/member/form/status/".enc_uri($id_person)."/$id_register")?>" <?=$this->uri->segment(4)=="status" ? 'class="active"':''?>><i class="ti-files"></i> Status AKun</a></li>
