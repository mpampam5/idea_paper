...
class Administrator_model extends MY_Model{
  ...
  var $column_order = array(null, 'nama','username','email','is_active','level');
  var $column_search = array('nama','username','email','is_active');
  ...
  private function _get_datatables_query()
    {
      ...
      $this->db->where("is_delete !=", "1");
        ...
        {
            $this->db->like('is_active', $this->input->post('is_active'));
        }
